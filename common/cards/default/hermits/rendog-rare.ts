...
import Card, {Hermit, CardProps, HermitSlot} from '../../base/card'

class RendogRareHermitCard extends Card<CardProps & HermitSlot & Hermit> {
	props: CardProps & HermitSlot & Hermit = {
		type: 'hermit',
		id: 'rendog_rare',
		numericId: 87,
		name: 'Rendog',
