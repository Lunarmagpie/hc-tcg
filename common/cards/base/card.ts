...
export interface EffectDisplayInfo { __effect_display_info: undefined }
...
export function implementsIsAttachableToSingleUseSlots(obj: any): obj is IsAttachableToSingleUseSlots {
