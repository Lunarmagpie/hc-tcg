import {CardComponent, PlayerComponent, RowComponent} from '../components'
...
export function flipCoin(
	...
	const activeRowIndex = playerTossingCoin.game.components.get(RowComponent, playerTossingCoin.activeRowEntity)
