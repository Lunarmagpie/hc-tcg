...
import Iskall85RareHermitCard from 'common/cards/default/hermits/iskall85-rare'
import { implementsIsCard } from 'common/cards/base/card'
...
console.log(implementsIsCard(Iskall85RareHermitCard()))
